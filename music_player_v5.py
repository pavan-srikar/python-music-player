...
root = Tk()
root.title("Pavan's Music Player")
...
prev_button = Button(button_frame, text="《", command=prev_song)
prev_button.grid(row=0, column=1, padx=5)

play_pause_button = Button(button_frame, text="⏵︎", command=toggle_play_pause)
play_pause_button.grid(row=0, column=2, padx=5)

next_button = Button(button_frame, text="》", command=next_song)
next_button.grid(row=0, column=3, padx=5)

stop_button = Button(button_frame, text="⏹︎", command=stop_song)
